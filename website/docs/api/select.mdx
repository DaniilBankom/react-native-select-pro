...
| `theme`                    | `none` \| `light` \| `dark`   | `none`                              | Pre-prepared styles for light and dark theme. They can be overwritten.                                                                                                                                                                                     | <TableExample expo={<Theme />} />                    |
...
| `fullClear` | `() => void`                                                                                                                                                                                | `clear everything`. | ✅  |
